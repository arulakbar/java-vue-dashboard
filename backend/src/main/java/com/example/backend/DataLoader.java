...
public class DataLoader {
    ...
    // "I'm baby woke mlkshk wolf bitters live-edge blue bottle, hammock freegan
    ...
    // "Shabby chic keffiyeh neutra snackwave pork belly shoreditch. Prism austin
    // mlkshk truffaut",
    // 20.99, "test", breakfast),
    ...
    // "carry jianbing normcore freegan. Viral single-origin coffee live-edge, pork
    // belly cloud bread iceland put a bird ",
    // 8.99, "test", breakfast),
    // new Product("american classic",
    // "on it tumblr kickstarter thundercats migas everyday carry squid palo santo
    // leggings. Food truck truffaut",
    // 12.99, "test", shakes),
